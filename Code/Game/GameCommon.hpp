...
constexpr float PLAYER_SHIP_ACCELERATION = 100.f;
constexpr float PLAYER_SHIP_MAX_SPEED = 80.f;
...
constexpr float EXPLOSION_PHYSICS_RADIUS = 12.f;
constexpr float EXPLOSION_COSMETIC_RADIUS = 12.f;
